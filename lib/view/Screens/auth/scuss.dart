  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: PreferredSize(
        ...
        child: AppBar(backgroundColor: AppColor.c),
      ),
      body: SafeArea(
        child: SingleChildScrollView(
          child: Container(
            padding: const EdgeInsets.all(15),
            height: MediaQuery.of(context).size.height - 20, // يأخذ كامل الشاشة تقريبًا
            child: Column(
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context)
                      .textTheme
                      .bodyLarge!
                      .copyWith(fontSize: 18, color: AppColor.colorGray2),
                ),
                const Spacer(),
                CustomButtom(
                  textbuttom: '56'.tr,
